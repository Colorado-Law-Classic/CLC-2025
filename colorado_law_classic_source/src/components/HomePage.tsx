...
import EventDetailsCard from './EventDetailsCard' // Assuming EventDetailsCard is in the same directory
...
const HomePage: React.FC = () => {
  const eventDetails = {
    ...
    // Registration info on HomePage is slightly different, so we'll use additionalInfo for that part
  };

  const homePageRegistrationInfo = (
    <>
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 bg-white">
        <div className="container">
          {/* The EventDetailsCard is used here */}
          <EventDetailsCard
            schedule={eventDetails.schedule}
            location={eventDetails.location}
            additionalInfo={homePageRegistrationInfo}
          />
        </div>
      </section>
