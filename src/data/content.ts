...
export const defaultContent: SiteContent = {
  event: {
    ...
    edition: "15th Annual",
    date: "August 16, 2026",
    dateISO: "2026-08-16T07:30:00-06:00",
    checkIn: "6:30 AM",
    teeOff: "7:30 AM",
    ...
    coursePar: 70,
    courseYards: "6,703",
    registrationUrl: "https://coloradolawclassic.org/home/register-here/",
  },
  hero: {
    badge: "2026 Tournament Edition",
    heading: "A Legacy of",
    headingHighlight: "Excellence",
    subtitle: "The premier charity golf tournament benefiting scholarship funds at CU Law School. Fifteen years of tradition, camaraderie, and purpose.",
    ctaPrimary: "Register to Play",
    ctaSecondary: "View Sponsorships",
  },
  impact: {
    label: "The Mission",
    heading: "Empowering Future Legal Minds",
    description: "The Colorado Law Classic is more than a day on the links. Since 2012, our annual tournament has raised critical scholarship funds for students at CU Law School, opening doors for future leaders in the legal profession.",
    features: [
      {
        title: "Diversity in Law",
        description: "Supporting underrepresented students pursuing legal careers through need-based scholarship aid.",
      },
      {
        title: "Academic Merit",
        description: "Recognizing exceptional academic achievement through the Sarah L. Rector Memorial Scholarship fund.",
      },
    ],
    amountRaised: "$500k+",
  },
  stats: [
    ...
    { number: "26", label: "Years of Tradition" },
  ...
  gallery: [
    { src: "/images/gallery/2025-1.jpg", alt: "Colorado Law Classic flyer", year: "2026" },
    { src: "/images/gallery/2025-2.jpg", alt: "Colorado Law Classic kickoff speaker", year: "2026" },
  ...
  footer: {
    description: "A charity golf tournament benefiting scholarship funds at CU Law School. Fifteen years of tradition, camaraderie, and purpose.",
  ...
  anniversary: {
    ...
    story: [
      "For fifteen years, the Colorado Law Classic has brought together alumni, legal professionals, and friends of Colorado Law for a day of friendly competition and meaningful giving.",
      "What started as a small gathering of golf enthusiasts has grown into one of the premier charity events supporting scholarship funds at CU Law School. Each year, participants tee off knowing their entry fees and sponsorships directly support the next generation of legal professionals.",
